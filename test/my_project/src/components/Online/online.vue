          ...
          <a href="javascript:;" class="online-link">
            <div class="online-detail">
              ...
              <div class="match-info">
                ...
                <!-- <img :src="defaultlogo" /> -->
                <div class="team">
                  <p><img :src="item.hteamLogo==null?defaultlogo:baseUrl+item.hteamLogo" alt="">{{item.hteam}}</p>
                  <p><img :src="item.gteamLogo==null?defaultlogo:baseUrl+item.gteamLogo" alt="">{{item.gteam}}</p>
                </div>
                <div class="period">
                  <i></i>
                  <p>{{item.league}}</p>
...
import qss from './../../../node_modules/qs/dist/qs'
  ...
  export default {
    ...
    data(){
      return {
        //baseUrl:'http://localhost/nba2/',
        noData:false,
        OnlineList:true,
        OlineData:[],
        defaultlogo:require('../../../static/logo.png')
      }
    },
    computed:{

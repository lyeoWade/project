			...
			for ($i=0; $i <count($datas[1]); $i++) { 
				...
				if(!$isEnd){
					if($isEnd2){ //有标题但是状态更新中则更新
						//var_dump($isEnd2['id']);
						$UpdataOneArticle="UPDATE vipvideo SET content='".$content."',zhuyan='".$empty."',singalChange='1',miaoshu='".$empty."',coverPic='".$coverpic."', videoType='".$videoType."' , status='".$status."' , statusTip='".$statusTip."' , createTime='".$tt."'  WHERE id=".$isEnd2['id'];

		...
		<div class="user_data fl">
			...
			<div class="user_pic">
				...
				<ul class="user_data_list" id="user_data_list">
                    ...
                    <li class="active"><a href="keyrank.html"><i class="fa fa-angle-right"></i>重点排行</a></li>
							...
							<div class="gusetwarp">
                            	...
                            	<div class="newguestwarp guessrank">
                                    ...
                                    <table>
                                        ...
                                        <tbody id="tbody">
                                            <?php 
                                                $mysql=mysql_query("SELECT * FROM keyrank order by keypercent desc") or die("查询失败.");
                                                $i=1;
                                            ...
                                            <tr>
                                                ...
                                                <td class="w50"><?php echo $mysqlRow['keyAll'];?></td>
                                                <td class="w50 red ranknum ranknum"><?php echo $mysqlRow['keyWin'];?></td>
                                                <td class="w50"><?php echo $mysqlRow['keyAll']-$mysqlRow['keyWin']-$mysqlRow['keyFail'];?></td>
                                                <td class="w50"><?php echo $mysqlRow['keyFail'];?></td>
                                                <td class="w100 ranknum red"><?php echo $mysqlRow['keypercent']*100;?>%</td>

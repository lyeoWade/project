		...
		<div class="user_data fl">
			...
			<div class="user_pic">
				...
				<ul class="user_data_list" id="user_data_list">
                    ...
                    <li class="active"><a href="quarterrank.html"><i class="fa fa-angle-right"></i>季排行榜</a></li>
							...
							<div class="gusetwarp">
                            	...
                            	<div class="newguestwarp guessrank">
                                    ...
                                    <table>
                                        ...
                                        <tbody id="tbody">
                                            <?php 
                                                $mysql=mysql_query("SELECT * FROM quarterrank order by quarterpercent desc") or die("查询失败.");
                                                $i=1;
                                            ...
                                            <tr>
                                                ...
                                                <td class="w50"><?php echo $mysqlRow['quarterAll'];?></td>
                                                <td class="w50 red ranknum"><?php echo $mysqlRow['quarterWin'];?></td>
                                                <td class="w50"><?php echo $mysqlRow['quarterAll']-$mysqlRow['quarterWin']-$mysqlRow['quarterFail'];?></td>
                                                <td class="w50"><?php echo $mysqlRow['quarterFail'];?></td>
                                                <td class="w100 ranknum red"><?php echo $mysqlRow['quarterpercent']*100;?>%</td>

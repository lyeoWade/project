			...
			<div class="user-t-center clearfix">
				...
				<div class="user-warp clearfix">
					...
					<div class="user-myway fl">
						<h2>历史竞猜</h2>
                        <div class="colums">
                        	<!-- <a href="my_guess.html">最新竞猜</a>
                            <a href="my_guess_history.html" class="active">历史竞猜</a>
                            ...
                            <?php
                                if($_GET['id'] && $_GET['id']!=$_COOKIE['userid']){
                                    ...
                                    echo '<a href="my_guess'.$_GET['id'].'.html">最新竞猜</a>
                                        <a href="my_history_guess'.$_GET['id'].'.html" class="active">历史竞猜</a>';
                                }else{
                                    //include 'member_head.php';

                                    echo '<a href="my_guess.html">最新竞猜</a>
                                            <a href="my_history_guess.html" class="active">历史竞猜</a>
                                            <a href="follow.html">我的关注</a>
                                            <a href="viewlog.html">查看记录</a>';
                                } 
                            ?>
						...
						<div class="gusetwarp">
                        	...
                        	<div class="newguestwarp">
                                <div class="choicewrap">
                                    <a class="guessTypeTag" guessType="" href="javascript:;">全部</a>
                                    <a class="guessTypeTag" guessType="4" href="javascript:;">全场大小</a>
                                    <a class="guessTypeTag" guessType="3" href="javascript:;">全场让分</a>
                                    <a class="guessTypeTag" guessType="1" href="javascript:;">半场让分</a>
                                    <a class="guessTypeTag" guessType="2" href="javascript:;">半场大小</a>
                                    <a class="isKey" isKey="1" href="javascript:;">重点竞猜</a>
                                </div>
                            	<div class="line">
                                    	<table class="table-warp">
                                    		...
                                    		<tbody id="history">
                                    			<tr>
                                                    <td colspan="7">暂无竞猜,<a href="guess.html" target="_blank">去竞猜</a></td>
                                                </tr>
                                    		</tbody>
                                    	</table>
                                </div>

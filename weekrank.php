		...
		<div class="user_data fl">
			...
			<div class="user_pic">
				...
				<ul class="user_data_list" id="user_data_list">
                    ...
                    <li class="active"><a href="weekrank.html"><i class="fa fa-angle-right"></i>周排行榜</a></li>
							...
							<div class="gusetwarp">
                            	...
                            	<div class="newguestwarp guessrank">
                                    ...
                                    <table>
                                        ...
                                        <tbody id="tbody">
                                            <?php 
                                                $mysql=mysql_query("SELECT * FROM weekrank order by weekpercent desc") or die("查询失败.");
                                                $i=1;
                                            ...
                                            ?>
                                                ...
                                                <td class="w50"><?php echo $mysqlRow['weekAll'];?></td>
                                                <td class="w50 red ranknum"><?php echo $mysqlRow['weekWin'];?></td>
                                                <td class="w50"><?php echo $mysqlRow['weekAll']-$mysqlRow['weekWin']-$mysqlRow['weekFail'];?></td>
                                                <td class="w50"><?php echo $mysqlRow['weekFail'];?></td>
                                                <td class="w100 ranknum red"><?php echo $mysqlRow['weekpercent']*100;?>%</td>
